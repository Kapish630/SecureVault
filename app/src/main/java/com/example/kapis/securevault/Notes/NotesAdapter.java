...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            title = view.findViewById(R.id.notes_RowTitle);
            body = view.findViewById(R.id.notes_RowBody);
            dot = view.findViewById(R.id.notesRowDot);
            timestamp = view.findViewById(R.id.notes_RowTime);
        }
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.timestamp.setText(formatDate(notes.getTimestamp()));
    }
